...
cMenueItem::cMenueItem(std::string pName, OK_Function pOK_Function)
{
	mName = pName;
...
std::string cMenueItem::getSubmenueItemName(int pIndex)
{
	return mSubMenueItems->getNextMenueItemName(pIndex);
}
std::string cMenueItem::getNextMenueItemName(int pIndex)
{
	if (mIndex == pIndex)
